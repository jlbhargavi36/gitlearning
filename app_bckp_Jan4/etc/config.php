...
return [
    'modules' => [
        ...
        'Aceturtle_AvailableInventory' => 1,
        'Aceturtle_CartPopup' => 1,
        'Aceturtle_CheckoutChanges' => 1,
        'Aceturtle_Chkoutplcholderchng' => 1,
        'Aceturtle_Cspallow' => 1,
        'Aceturtle_Csvdownload' => 1,
        'Aceturtle_CustomerAccountChanges' => 1,
        'Aceturtle_Dashboardtracking' => 1,
        'Aceturtle_Employeediscount' => 1,
        'Aceturtle_Extratabs' => 1,
        'Aceturtle_Extratabsstyling' => 1,
        'Aceturtle_General' => 1,
        'Aceturtle_GuestTrack' => 1,
        'Aceturtle_Productposition' => 1,
        'Aceturtle_Quickview' => 1,
        'Aceturtle_Redirectcolor' => 1,
        'Aceturtle_RegenProductPos' => 1,
        'Aceturtle_Rubicon' => 1,
        'Aceturtle_Sortby' => 1,
        'Aceturtle_Swatchselect' => 1,
