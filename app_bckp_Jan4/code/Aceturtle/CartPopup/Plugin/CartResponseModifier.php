...
namespace Aceturtle\CartPopup\Plugin;

/**
 * Class CartResponseModifier
 *
 * @package Aceturtle\CartPopup\Plugin
 */
class CartResponseModifier
{
    /**
     * @var \Aceturtle\CartPopup\Model\RelatedProductsBlockBuilder
     */
    private $relatedBlockBuilder;

    /**
     * @var \Aceturtle\CartPopup\Model\OptionsBlockBuilder
     */
    ...
    /**
     * @var \Aceturtle\CartPopup\Model\LastAddedItemsStorage
     */
     ...
     *
     * @param \Aceturtle\CartPopup\Model\RelatedProductsBlockBuilder $relatedBlockBuilder
     * @param \Aceturtle\CartPopup\Model\OptionsBlockBuilder $optionsBlockBuilder
     * @param \Magento\Framework\Message\ManagerInterface $messageManager
     * @param \Magento\Catalog\Api\ProductRepositoryInterface $productRepository
     * @param \Aceturtle\CartPopup\Model\LastAddedItemsStorage $itemsStorage
     * @param \Magento\Framework\Data\Form\FormKey\Validator $formKeyValidator
     * @param \Psr\Log\LoggerInterface $logger
     * @param \Magento\Framework\Serialize\Serializer\Json|null $serializer
     */
    public function __construct(
        \Aceturtle\CartPopup\Model\RelatedProductsBlockBuilder $relatedBlockBuilder,
        \Aceturtle\CartPopup\Model\OptionsBlockBuilder $optionsBlockBuilder,
        \Magento\Framework\Message\ManagerInterface $messageManager,
        \Magento\Catalog\Api\ProductRepositoryInterface $productRepository,
        \Aceturtle\CartPopup\Model\LastAddedItemsStorage $itemsStorage,
