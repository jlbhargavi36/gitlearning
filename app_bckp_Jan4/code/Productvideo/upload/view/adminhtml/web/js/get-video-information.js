...
/********************Lee Modification starts**************/
 /*   $("#btnvideoupload").click(function() {
    
		var Videodata = jQuery("#new_video_form").get(0);
                
                jQuery.ajax({
                     url: "https://lee.aceturtle.in/videoupload/Uploadvideoinfo/Index",
                     type: "POST",
                      enctype: 'multipart/form-data',
                     data: new FormData(Videodata),
                     processData: false,
                     contentType: false,
                     showLoader: true,
                     success: function (response) {
                      jQuery("#video_url").val(response);                        
             }});
    
    });*/
    
/********************Lee Modification ends**************/
        ...
        $.widget('mage.productVideoLoader', {
            ...
            _create: function () {
                switch (this.element.data('type')) {
                  ...
                  /*************lee modification starts***********/
                    case 'lee':
                        this.element.videolee();
                        this._player = this.element.data('magevideolee');
                        break;
                   /*************lee modification starts***********/      
    ...
    /****************Lee modification starts*************/
             $.widget('mage.videolee', $.mage.productVideoLoader, {
    ...
    /****************Lee Modification ends***************/
        ...
        $.widget('mage.videoData', {
           ...
           /***************lee Modification starts******************/     
                 function _onLeevideoLoaded(data) {
                    var tmp,
                        respData;
           ...
           /***************lee Modification end******************/      
            ...
            /*************lee modification starts********/
		       ...
		       jQuery.ajax({
                        url: document.location.origin+'/rest/V1/get_VideoInfo',
                        method:"GET",
                        //timeout: 5000,
                         data:{url:document.location.origin+"/pub/media/Cute_pandas_playing_on_the_slide.mp4"},
                        //success:function(data) {self._videoInformation=data;$.proxy(_onLeevideoLoaded, self)},
                        success:  $.proxy(_onLeevideoLoaded, self),
            ...
            _validateURL: function (href, forceVideo) {
               ...
               /************lee changes start*****/      
                else if (href.host.match(document.location.hostname)) {
                    type = 'lee';
		     id='lee';
                }
              /************lee changes end*****/
